...
from .choices import InboxKind, InboxStatus, ThreadKind
...
class Thread(BaseModelWithUID):
    ...
    participants = models.ManyToManyField(
        settings.AUTH_USER_MODEL, through="Inbox", blank=True
    )
...
class Inbox(BaseModelWithUID):
    ...
    class Meta:
        ordering = ("-updated_at",)
        index_together = (("thread", "organization"), ("thread", "user"))
        unique_together = (("thread", "organization"), ("thread", "user"))
