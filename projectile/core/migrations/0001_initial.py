# Generated by Django 4.1.3 on 2023-01-12 21:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('objective', models.CharField(blank=True, choices=[('UNKNOWN', 'Unknown'), ('SUPPLIER', 'Supplier'), ('RETAILER', 'Retailer'), ('ARCHITECT', 'Architect'), ('OTHER', 'Other')], db_index=True, max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('PENDING', 'Pending'), ('ACTIVE', 'Active')], db_index=True, default='PENDING', max_length=20)),
